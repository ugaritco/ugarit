...
## Autodiscovery
When `config('artifacts.autodiscovery')` is enabled, all active artifacts located in this directory have their service providers registered and booted automatically in `AppServiceProvider`.
